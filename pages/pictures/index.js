  ...
  return (
    <Container>
      ...
      <SimpleGrid columns={[1, 1, 1, 2]} spacing='30px'>
        <Box>
          <Image src='/images/picture1.jpg' alt='Photo of a winged out climber' />
        ...
        <Box>
          <Image src='/images/picture2.jpg' alt='Photo of a climber thinking' />
          <Text align='center' color={colorSecondary[colorMode]}>
        ...
        <Box>
          <Image src='/images/picture3.jpg' alt='Photo of climbers in the Alps' />
          <Text align='center' color={colorSecondary[colorMode]}>
            Alps in the summer is one of the best places on earth! <br /> Photo: Lisa Godless
          </Text>
        </Box>
        <Box>
          <Image src='/images/picture4.jpg' alt='Photo of a high mountain top over the clouds' />
          <Text align='center' color={colorSecondary[colorMode]}>
